...
const MainPage = ({ showCard, userIn, posts, addP, unPost, isNotAddPost, filterID, fl, logOut,searchID,refresh}) => {
  ...
  return (
    <div className={`mainpage ${showCard ? "mainpage--show" : ""}`}>
      ...
      <div className="cardCont">
        ...
        <Navbar unPost={unPost} filterID={filterID} fl={fl} logOut={logOut} searchID={searchID} refresh={refresh}/>
      </div>
